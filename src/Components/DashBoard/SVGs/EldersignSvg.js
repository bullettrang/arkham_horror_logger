...
const EldersignSvg =(props)=>{
    return(
<svg width={props.width} height={props.height} viewBox="0 0 95 97" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" className="eldersignsvg">
